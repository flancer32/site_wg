...
- [<span class="citation"
  cites="param">@param</span>](http://twitter.com/param)
  {http.IncomingMessage\|http2.Http2ServerRequest}req

- [<span class="citation"
  cites="param">@param</span>](http://twitter.com/param)
  {http.ServerResponse\|http2.Http2ServerResponse} res
...
“<span class="citation" cites="teqfw/web">@teqfw/web</span>”: {
...
https://host.com/src/<span class="citation"
cites="vnd/pkg/Path/To/Module.mjs">@vnd/pkg/Path/To/Module.mjs</span>
соответствует такому пути к файлу внутри проекта:

./node_modules/<span class="citation"
cites="vnd/pkg/sources/Path/To/Module.mjs">@vnd/pkg/sources/Path/To/Module.mjs</span>
...
https://host.com/web/<span class="citation"
cites="vnd/pkg/css/style.css">@vnd/pkg/css/style.css</span>
соответствует такому пути к файлу внутри проекта:
...
http://localhost/api/<span class="citation"
cites="teqfw/web/load/namespaces">@teqfw/web/load/namespaces</span>
