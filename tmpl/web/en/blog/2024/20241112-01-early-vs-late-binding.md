...
description: "The difference between early and late binding is significant but can be challenging to grasp — especially from a developer’s perspective. In this article, I’ll share a foundational"
date: 2024-11-12
display_date: "2024-11-12"
image: "/medium/img/d80c6b985f4b/image-01.jpg"
image_alt: "Image 2"
---
...
We can simulate interfaces in JavaScript using JSDoc [annotations](https://jsdoc.app/tags-interface), like this:
...
This is the fundamental marker of late binding: **if**[your code](https://github.com/flancer64/pwa-wallet/blob/main/src/Front/Ui/Route/Settings.js#L24)**has dependencies but lacks static imports, you’re using late binding**. This principle helps to identify when dependencies are being resolved dynamically, making your code more flexible and modular.
...
- [InversifyJS](http://inversify.io/) — A powerful DI container for TypeScript and JavaScript with support for decorators and type annotations.

- [Awilix](https://github.com/jeffijoe/awilix) — A flexible and lightweight DI container for Node.js, optimized for Express and modular applications.

- [BottleJS](https://github.com/young-steveo/bottlejs) — A minimalist DI container for JavaScript, supporting factories and services.

However, I found that these libraries lack full compatibility with plain JavaScript that works seamlessly in both the browser and Node.js. So I created my own library, [teqfw/di](https://github.com/teqfw/di) — a small but fully functional DI library with a [UMD bundle](https://cdn.jsdelivr.net/npm/@teqfw/di@0.30.2/dist/umd.js) size of about 2.4kB.

![Image 3](/medium/img/d80c6b985f4b/image-02.png)
