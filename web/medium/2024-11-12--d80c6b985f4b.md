...
date: 2024-11-12
source: "https://flancer32.com/understanding-early-vs-late-binding-in-javascript-d80c6b985f4b"
medium_id: d80c6b985f4b
---
...
![Image 2](img/d80c6b985f4b/image-01.jpg)
...
This is the fundamental marker of late binding: **_if_**[**_your code_**](https://github.com/flancer64/pwa-wallet/blob/main/src/Front/Ui/Route/Settings.js#L24)**_has dependencies but lacks static imports, you’re using late binding_**. This principle helps to identify when dependencies are being resolved dynamically, making your code more flexible and modular.

## Dependency Injection

JavaScript code without static imports is often typical when using _dependency injection_ (DI). Several excellent DI libraries are available:
...
![Image 3](img/d80c6b985f4b/image-02.png)

This library lets me harness the power of late binding in my applications, along with the ability to use “_interfaces_” in JavaScript. With this library, I can configure dependencies directly within the code and without any static imports:
...
But to _be_ a magician, you have to _think_ like a magician and _code_ like a magician. I hope this article helps you take a step toward mastering that mindset!
