...
Define the semantic responsibilities of shared template-composed widgets without inventing runtime abstractions.

## Stable Widgets

The shared shell uses template-composed navigation, locale control, footer discovery, commercial-action links, content cards, status presentation, and publication discussion CTA where authored. Widgets remain progressively enhanced SSR content; they do not require Web Components or client-side state merely to express a semantic role.
