...
Describe the retained `/{locale}/projects.html` route as the SSR Current Work surface while preserving the route and historical material.
...
The lower archive keeps existing project material and original descriptions as previous or historical responsibility evidence. It is explicitly secondary to active Current Work and must not be treated as current status or modern agentic-AI delivery evidence without contemporaneous proof.
