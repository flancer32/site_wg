...
The direct-contact area retains `@wiredgeese` and lists the Alex Gusev Lab Telegram channel matching the current page locale as a public activity destination. These links are informational and communicative only; the page does not collect Telegram credentials, create a channel integration, or promise a response or service through a public channel.
