...
- `verification/` — crosscutting checks that trace the four authoritative documentation levels to inspectable project evidence without defining a fifth authority level.
