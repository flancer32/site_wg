...
5. What technology and experience support the offer?
6. What should I do next if I want it?
...
This is a semantic information-architecture requirement, not an approved navigation tree or page specification. Final routes, labels, page composition, and copy remain open for a later implementation task.
...
Preservation does not require obsolete offers to remain promoted or described as current.
